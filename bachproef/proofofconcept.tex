...
% TODO: 10.21608/EJAI.2022.132961.1002
Relationele databanken slaan gegevens op aan de hand van tabellen die beschreven staan in een relationeel model \autocite{bron}. 
De betrouwbarheid van een  realtionele databank wordt getoetst met ACID eigenschappen. Deze eigenschappen worden als volgt gedefinieerd foor \textcite{bron}:
...
De meest voorkomende types van niet-relationele databanken zijn document- kolom- en graafdatabanken en key-value stores \autocite{bron}.
