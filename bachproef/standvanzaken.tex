...
\begin{table}[h]
    ...
    \includegraphics[width=1\textwidth]{NeedsToGamification}
...
\textcite{ManzanoLeon2021} beschrijven hoe deze techniek voldoet aan de ``Self-Determination Theory'' (SDT), zoals beschreven in \ref{ssec:werking-gamification}. Gebruikers kunnen, bij het gebruik van levels, namelijk op een autonome manier evolueren doorheen deze levels, ze voelen zich competent wanneer ze slagen en gezien iedereen dezelfde niveaus doorloopt, ontstaat er een gevoel van verbondenheid.
